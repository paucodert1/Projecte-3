...
session_start();
con();
obtenirCursosIndividuals();
obtenirCursosColectius();
obtenirCursosCompeticio();
...
<body>
    ...
    <div class="main">
        <div class="section">
            <div id="contenidor-historial-Individual">
                <?php 
                    $result = obtenirCursosIndividuals();
                    while($row = $result -> fetch_assoc()){
                ?>
                <div id="caixa">
                    <table>
                        <thead>
                            <h2>CURSOS INDIVIDUALS</h2>
                            <br>
                            <tr>
                                <th>ID</th>
                                <th>Nom</th>
            ...
            <div id="contenidor-historial-Colectiu">
                <?php 
                    $result = obtenirCursosColectius();
                    while($row = $result -> fetch_assoc()){
                ?>
                <div id="caixa">
                    <table>
                        <thead>
                            <h2>CURSOS COLECTIUS</h2>
                            <br>
                            <tr>
                                <th>ID</th>
                                <th>Nom</th>
                        ...
                        <tbody id="productes_carrito">
                            <td><?php echo $row['id']?></td>
                            <td><?php echo $row['nom']?></td>
                            <td><?php echo $row['cant_persones']?></td>
                            <td><?php echo $row['preu_final']?>€</td>
                        </tbody>
                    </table>
                </div>
            ...
            <div id="contenidor-historial-competicio">
                <?php 
                    $result = obtenirCursosCompeticio();
                    while($row = $result -> fetch_assoc()){
                ?>
                <div id="caixa">
                    <table>
                        <thead>
                            <h2>CURSOS COMPETICO</h2>
                            <br>
                            <tr>
                                <th>ID</th>
                                <th>Nom</th>
