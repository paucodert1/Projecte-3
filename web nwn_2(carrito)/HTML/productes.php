    ...
    <div class="main">
        <div class="section">
            <div id="contenidor-botiga">
                ...
                ?>
                <div id="caixa">
                    <img src="../img/<?php echo $row['foto']?>" alt="" class="img">
                    <h2 class="model"><?php echo $row['model']?></h2>
                    <h2 class="marca"><?php echo $row['marca']?></h2>
                    <p><span class="preu"><?php echo $row['preu']?></span>€</p>
                    <input type="button" value="AFEGIR AL CARRITO" class="comprar" id="<?php echo $row['id'] ?>">  
